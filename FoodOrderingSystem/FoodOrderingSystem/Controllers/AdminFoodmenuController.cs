...
{
    public class AdminFoodmenuController : Controller
    {
        ...
        public ActionResult addtocart(string foodsn)
        {
            ...
            con.Close();
            return RedirectToAction("Foods", "Adminpage");
        }
        ...
        public ActionResult orderconfirm(string foodsn, string quantity)
        {
            ...
            return RedirectToAction("oder", "AdminFoodmenu");
        }
        ...
        public ActionResult bookingdone(string fullname, string contact, string email, string address)
        {
            ...
            con.Close();
            return RedirectToAction("oderdisplay", "AdminFoodmenu");
        }
        ...
        [HttpPost]
        public ActionResult removefood(string foodsn)
        {
            int sn = Convert.ToInt32(foodsn);
            SqlConnection con = new SqlConnection(constring);
            con.Open();
            string query = "DELETE FROM Foodmenu Where SN='" + sn + "'";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
            sda.SelectCommand.ExecuteNonQuery();
            con.Close();
            return RedirectToAction("Foods", "Adminpage");
        ...
        [HttpPost]
        public ActionResult adddataitem(string foodname, string file,string fooddetail,string foodprice,string foodcategory)
        {
            SqlConnection con = new SqlConnection(constring);
            con.Open();
            string query = "Insert into Foodmenu(Foodname,FoodDetail,FoodPrice,FoodCategory,Foodpicture)Values('" + foodname + "','" + fooddetail + "','" + foodprice + "','" + foodcategory + "','" + file + "')";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
            sda.SelectCommand.ExecuteNonQuery();
            con.Close();
            return RedirectToAction("Foods", "Adminpage");
